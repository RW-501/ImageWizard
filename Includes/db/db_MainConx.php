<?php
		...
		$DB_HostName = "107.180.2.245";

		$DB_Name = "PhotoWizard";

		$DB_User = "PhotoWizardAdmin";

		$DB_Pass = "PhotoWizardAdmin321";
...
/// main
/// include_once("../../../ImageWizard/db_Conx/db_Conx/db_MainConxNew.php");


/// folder
/// include_once("../../../ImageWizard/Includes/db/db_MainConxNew.php");
